	...
	<div class="container">
		<div class="table_email" style="background-color: #f1fffe; margin-top: 30px;">
				     <a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                    ...
                                    <img src="{{url('frontend/images/logo.png')}}" width="50%" alt="Evernote" border="0"  style="width: 35%;display: flex;
    margin: 0 auto;
...
<!-- 	<div class="logo_table" style="display: flex; flex-direction: row; justify-content: center; padding-top: 30px;">
		<img src="{{url('logo.png')}}" width="250px" style="margin: 0 auto;">
	</div> -->
				<div class="link_site">
					<p style="text-align: center; padding-top: 2px;">
						...
						{{ url('/email_confirmation/'.$link) }}<br><br>
						Thanks.
					</p>

					<div class="container" style="    width: 80%;margin: 0 auto;">
					<!-- 	<a class="btn cust_img_btn" style="border:0;" type="btn" href="#"><img style="width: 45%;margin: 0 auto;display: flex;" class="img-responsive" src="http://prizemaker.stepinnsolution.com/frontend/images/sig_up.png"></a> -->
						<div class="row cust_main" style="  border-top: 2px solid #b1b1b16e;;margin: 18px 0;border-radius: 7px;box-shadow: 2px 9px 8px 4px #88888870;padding: 10px;    padding-bottom: 25px;margin-top: 0;">
							<div class="col-md-6 ">
								...
								<img style="    width: 50%;margin-bottom: 10px;display: flex;margin: 0 auto;" class="img-responsive" src="{{url('frontend/images/share-and.png')}}">
							</div>
							<div class="col-md-6 " style="    margin-top: 25px;">
								...
								<img style="    width: 50%;margin-bottom: 10px;display: flex;margin: 0 auto;" class="img-responsive" src="{{url('frontend/images/business.png')}}">
							</div>
    ...
    <td class="full_width" align="center" width="100%" bgcolor="#f1fffe" style=""><div class="div_scale" style="">
        <table class="table_scale" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f1fffe" style="padding:0; margin: 0; border-top: 1px solid #fff;">
          <tbody><tr>
            ...
            <td class="social_right" align="right" valign="top" width="367" bgcolor="#f1fffe" style=""><table width="100%">
                ...
                <tr>
                  <td class="center" align="right" valign="top" bgcolor="#f1fffe" style="padding: 0px; text-shadow: 1px 1px 0px #ffffff;font-size:16px ; line-height: 26px; color:#262626; font-family: Lucida Sans Unicode; "><span> 
