	...
	<div class="col-md-12">
		<div class="tile">
			<h3 class="tile-title">
				...
				<a href="{{ route('addPropertyType')}}" class="btn btn-sm btn-success pull-right cust_color"><i class="fa fa-plus"></i> @lang('packages.add_new')</a>
				@endif
			</h3>
						...
						<tr>
							...
							<td class="text-center">
								<div class="actions-btns " style="display: flex;">
									...
									<a href="{{route('updatePropertyType' ,[$row->id])}}" class="back_color btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
		...
		swal({
			...
			if ( result.value == true ) {
				$.ajax( {
					...
					url: '<?php echo route("deletePropertyType"); ?>',
					data: form_data,
