...
{{--blogs          --}}
          ...
          {{--          --}}
{{--          Blogs Categories--}}
          <li><a class="app-menu__item <?php if(Request::segment(1) == "users") echo "active"; ?>" href="{{url('')}}"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Blog Category</span></a></li>
