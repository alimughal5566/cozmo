...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="row main-top-row">
        <div class="col-md-12">
            ...
            @endif
            <form class="form-horizontal" method="POST" action="{{ route('property_image.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label>Image</label>
                            <input id="image" value="{{ old('image')}}" type="text" placeholder="Enter image" class="form-control" name="image" required autofocus required="">
                        </div>
                    </div>
                ...
                <div class="tile-footer text-left mt-2">
                    <a class="btn btn-default" href="{{route('property_image')}}">Cancel</a>
{{--                    <a class="btn btn-default" href="{{route('building_info.admin')}}"type="submit">save</a>--}}
                    <button class="btn btn-primary" href="{{route('property_image')}}"type="submit">Save</button>
                </div>
