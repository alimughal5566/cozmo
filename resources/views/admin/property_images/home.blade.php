            ...
            <div class="tile">
                <h3 class="tile-title">
                    ...
                    @if(Auth::check() && Auth::user()->user_role == 1)
                        <a href="{{url('/property_image/add')}}" class="btn btn-sm btn-success pull-right cust_color"><i class="fa fa-plus"></i> @lang('add New')</a>
                    @endif
...
{{--                                    <th>date_created</th>--}}
                                ...
                                @foreach($users as $key=>$user)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class=" img-circle img-size-32 mr-2 round_img"  height="15%" src="/images/cozmo/{{$user->image}}" style="height: 30px">
