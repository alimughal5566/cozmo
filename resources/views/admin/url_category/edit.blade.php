...
<div class="row main-top-row">	
	<div class="col-md-12">
		...
		@endif
		<form class="form-horizontal" method="POST" action="{{ url('url_category_update/'. $url_category->id) }}" enctype="multipart/form-data">
			@csrf
			<div class="row">
			    <div class="col-md-8">
				...
				@endforeach
					<div class="form-group">
						<label>Title</label>
							<input id="title" value="{{$url_category->title }}" type="text" placeholder="Enter title" class="form-control" name="title" required autofocus>
					</div>
					<div class="form-group">
						<label>Description</label>
							<textarea name="description" cols="8" id="txtEditor" style="height: 35px;width: 100%;" required>
							{{$url_category->description}}								
							</textarea>
					</div>
				</div>					
			</div>
