...
@section( 'content' )
    ...
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item">Update Property Options</li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="{{ route('property_options.update') }}">
                {{ csrf_field() }}
                <div class="tile">

                    <h3 class="tile-title">Update Property Options</h3>
