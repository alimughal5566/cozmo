			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input required id="option_type"  type="text" placeholder="option_type" class="form-control" name="option_type">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input required id="option_key"  type="text" placeholder="option_key" class="form-control" name="option_key">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input required id="option_value"  type="text" placeholder="option_value" class="form-control" name="option_value">
