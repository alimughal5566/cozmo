...
<div class="row">
	<div class="col-md-12">
		<div class="tile">
			<h3 class="tile-title">
				<a href="{{route('iframe.create')}}" class="btn btn-sm btn-success pull-right cust_color"><i class="fa fa-plus"></i> @lang('packages.add_new')</a>
			</h3>
						...
						<tr>
							...
							<td class="text-center">
								<div class="actions-btns">
									<a href="{{url('iframe/edit/' . $row->id)}}" class="back_color btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
