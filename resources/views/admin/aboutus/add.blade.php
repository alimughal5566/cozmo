...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" method="POST" action="{{ route('pages.store') }}" enctype="multipart/form-data">
			@csrf
			<div class="tile">
				<h3 class="tile-title">Details About US</h3>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-3 col-lg-3">
						<div class="form-group">
							<label>Slug</label>
							<input id="slug" type="text" placeholder="Enter slug" class="form-control" name="slug" >
						</div>
					</div>
					<div class="col-lg-12" >
						<div class="form-group">
				...
				<div class="tile-footer text-right">
					<a class="btn btn-default" href="{{route('pages.admin')}}">Cancel</a>
