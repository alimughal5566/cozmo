    ...
    <div class="row main-top-row">
        <div class="col-md-12">
            ...
            @endif
                ...
                <form action="{{ route('building_document.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                ...
                <input id="ticket_1" type="hidden" name="data" class="form form-control" value="" required>
                    ...
                    @if(Auth::check())
                        <div class="tile-footer text-right ">
                            <a href="{{url('building_documents')}}" class="btn btn-default">@lang('general.cancel')</a>
