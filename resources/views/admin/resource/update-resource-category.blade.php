...
@section( 'content' )
    ...
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item">New Resource Category</li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="{{ route('storeResourceCategory') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="tile">

                    <h3 class="tile-title">New Resource Category</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input required id="title"  type="text" placeholder="Name" value="{{$data[0]->name}}" class="form-control" name="name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
