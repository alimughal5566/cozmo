...
@section( 'content' )
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" method="POST" action="{{ route('createResourceCategory') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="tile">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input required id="title"  type="text"  placeholder="Name" class="form-control" name="name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
