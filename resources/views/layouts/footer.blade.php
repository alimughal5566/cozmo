<style type="text/css">
  ...
  <div>
    ...
    <footer class="footer-bg">
          @php( $owners = \App\Setting::all()) 

      @foreach($owners as $val)
          <div class="social-icons">
            <h3>Follow Us On</h3>
            <ul class="social-ul">
              <li><a href="{{$val->twitter_link}}"><img src="images/twitter.png"></a> </li>
              <li><a href="{{$val->instagram_link}}"><img src="images/instagram.png"></a> </li>
              <li><a href="{{$val->twitter_link}}"><img src="images/pintrest.png"></a> </li>
              <li><a href="{{$val->facebook_link}}"><img src="images/facebook.png"> </a></li>
              <li><a href="{{$val->email}}"><img src="images/g+.png"></a> </li>
            </ul>
          </div>
          @endforeach()
          <div class="contentss">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <ul class="p-0 footer-ul" style="list-style: none;">
                    ...
                    <li><i class="fa fa-caret-right"></i> <a href="/charity">IPUG Charity</a></li>
